...
def build_system_prompt(workdir: str) -> str:
    ...
    return (
        ...
        "LANGUAGE: reply in Chinese (简体中文) by default — your EXPLANATIONS, "
        "summaries, progress notes and final answer should be in Chinese. Keep "
        "code, file paths, command names, tool names and identifiers exactly as "
        "they are (do not translate them). Tool calls and the code you write are "
        "always in English, but the prose around them is Chinese.\n"
